...
const uiuxStack: TechItem[] = [
  {
    name: 'Figma',
    category: 'uiux',
    icon: <img src="/Figma.png" alt="Figma" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Framer',
    category: 'uiux',
    icon: <img src="/framerr.png" alt="Framer" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Adobe XD',
    category: 'uiux',
    icon: <img src="/Adobe-XD.png" alt="Adobe XD" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Sketch',
    category: 'uiux',
    icon: <img src="/Sketch.png" alt="Sketch" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
];
...
const frontendStack: TechItem[] = [
  ...
  },
  {
    name: 'Next.js',
    category: 'frontend',
    icon: <img src="/Next.js.png" alt="Next.js" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'TypeScript',
    category: 'frontend',
    icon: <img src="/TypeScript.png" alt="TypeScript" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Tailwind CSS',
    category: 'frontend',
    icon: <img src="/Tailwind-CSS.png" alt="Tailwind CSS" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Framer Motion',
    category: 'frontend',
    icon: <img src="/framer.png" alt="Framer Motion" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'JavaScript',
    category: 'frontend',
    icon: <img src="/JavaScript.png" alt="JavaScript" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
];
...
const backendStack: TechItem[] = [
  {
    name: 'Node.js',
    category: 'backend',
    icon: <img src="/Node.js.png" alt="Node.js" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Laravel',
    category: 'backend',
    icon: <img src="/Laravel.png" alt="Laravel" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'PHP',
    category: 'backend',
    icon: <img src="/PHP.png" alt="PHP" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Python',
    category: 'backend',
    icon: <img src="/Python.png" alt="Python" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'FastAPI',
    category: 'backend',
    icon: <img src="/FastAPI.png" alt="FastAPI" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'MySQL',
    category: 'backend',
    icon: <img src="/MySQL.png" alt="MySQL" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'MongoDB',
    category: 'backend',
    icon: <img src="/MongoDB.png" alt="MongoDB" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Docker',
    category: 'backend',
    icon: <img src="/Docker.png" alt="Docker" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Git',
    category: 'backend',
    icon: <img src="/Git.png" alt="Git" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'AWS',
    category: 'backend',
    icon: <img src="/AWS.png" alt="AWS" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
];
...
const mobileStack: TechItem[] = [
  {
    name: 'Flutter',
    category: 'mobile',
    icon: <img src="/Flutter.png" alt="Flutter" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'React Native',
    category: 'mobile',
  ...
  },
  {
    name: 'Kotlin',
    category: 'mobile',
    icon: <img src="/Kotlin.png" alt="Kotlin" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Swift',
    category: 'mobile',
    icon: <img src="/Swift.png" alt="Swift" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Android',
    category: 'mobile',
    icon: <img src="/Android.png" alt="Android" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'iOS',
    category: 'mobile',
    icon: <img src="/ios.png" alt="iOS" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
];
...
const aiStack: TechItem[] = [
  {
    name: 'OpenAI',
    category: 'ai',
    icon: <img src="/openai.png" alt="OpenAI" loading="lazy" decoding="async" className="w-13 h-13 sm:w-15 sm:h-15 object-contain" />,
  },
  {
    name: 'LangChain',
    category: 'ai',
    icon: <img src="/langchain.png" alt="LangChain" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'LangGraph',
    category: 'ai',
    icon: <img src="/langgraph.png" alt="LangGraph" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
  {
    name: 'Python',
    category: 'ai',
  ...
  },
  {
    name: 'n8n',
    category: 'ai',
    icon: <img src="/n8n.png" alt="n8n" loading="lazy" decoding="async" className="h-13 sm:h-15 w-auto max-w-[68px] object-contain" />,
  },
];
